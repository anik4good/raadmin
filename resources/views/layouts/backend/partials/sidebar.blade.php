        ...
        <div class="nav-container">
            <nav id="main-menu-navigation" class="navigation-main">
                ...
                <div class="nav-item {{ ($segment1 == 'users' || $segment1 == 'roles'||$segment1 == 'permission' ||$segment1 == 'user') ? 'active open' : '' }} has-sub">
                    <a href="#"><i class="ik ik-user"></i><span>{{ __('Food')}}</span></a>
                ...
                <div class="nav-item {{ ($segment1 == 'users' || $segment1 == 'roles'||$segment1 == 'permission' ||$segment1 == 'settings'||$segment1 == 'user') ? 'active open' : '' }} has-sub">
                    ...
                    <!-- only those have manage_setting permission will get access -->
                        @can('manage_setting')
                            <a href="{{route('settings.appearance.index')}}" class="menu-item {{ ($segment1 == 'settings') ? 'active' : '' }}">{{ __('Setting')}}</a>
                        @endcan
                    </div>
                </div>
            </nav>
