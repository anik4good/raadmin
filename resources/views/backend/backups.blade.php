        ...
        <div class="page-header">
            ...
            <div class="page-title-actions">
                <div class="d-inline-block">
                    ...
                    <form id="clean-old-backups" action="{{ route('settings.backups.clean') }}" method="POST" style="display: none;">
                        @csrf
                        @method('DELETE')
                    </form>
                    ...
                    <form id="new-backup-form" action="{{ route('settings.backups.store') }}" method="POST" style="display: none;">
                        @csrf
                    </form>
                </div>
            </div>
